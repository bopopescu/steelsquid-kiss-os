...
# -*- coding: utf-8 -*-
#
# This is almost the same file as Joao Paulo Barraca
# Just fix it to work with Raspberry Pi.
# And also remove the IRQ stuff
#
...
class NRF24:
    ...
    def __init__(self, major=None, minor=None, ce_pin=None):
        self.ce_pin = 25
        self.channel = 76
