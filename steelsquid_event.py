...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        ...
        print("")
        steelsquid_utils.printb("steelsquid_event <event>")
        print("Broadcast event without parameters")
        print("")
        steelsquid_utils.printb("steelsquid_event <event> <parameter1> <parameter2>...")
        print("Broadcast event with paramaters")
        print("")
        steelsquid_utils.printb("steelsquid_event start <name>")
        print("Start execute (loop) a function with name <name>")
        print("")
        steelsquid_utils.printb("steelsquid_event stop")
        print("Stop execute (loop) all functions")
        print("")
        steelsquid_utils.printb("steelsquid_event stop <name>")
        print("Stop execute (loop) a function with name <name>")
        print("")
        steelsquid_utils.printb("steelsquid_event shutdown")
